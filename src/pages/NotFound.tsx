      ...
      <main className="relative z-10 h-screen overflow-hidden text-white landscape:max-xl:overflow-y-auto landscape:max-xl:pb-12">
        <div className="container relative flex min-h-full flex-col">
          ...
          <div className="absolute inset-x-0 top-[103px] z-[3] flex flex-col items-center gap-5 md:top-1/2 md:-translate-y-[39%] md:gap-20">
            ...
            <Button3DLink
              to="/"
              className="min-h-[61px] w-[min(252px,calc(100vw-64px))] text-[18px] md:min-h-[84px] md:w-[420px] md:text-[22px]"
            >
              <span className="hidden md:inline">Oops, take me back</span>
              <span className="md:hidden">Take me back</span>
            </Button3DLink>
          </div>
        </div>
        ...
        >
          <img
            src={snake404}
            alt=""
            className="absolute bottom-[-139px] left-[56px] h-auto w-[400px] max-w-none select-none md:bottom-[-25px] md:left-0 md:w-[clamp(390px,32vw,470px)] md:-scale-x-100"
          />
        </div>
      </main>
    </>
