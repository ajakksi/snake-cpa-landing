  ...
  return (
    <footer className="hidden md:block absolute inset-x-0 bottom-0 z-30">
      <div className="container flex justify-end">
        <div className="flex min-h-14 w-full flex-col items-center justify-center gap-4 text-[20px] font-bold uppercase leading-none tracking-[0.08em] text-yellow sm:flex-row sm:items-baseline sm:justify-between xl:max-w-[800px]">
          <nav
